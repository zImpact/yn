init python:
    ...
    yn_tip_phrases = {
        'geterohrom': '{b}Гетерохромия{/b} - редкое явление, редкое явление, предполагающее разный цвет глаз у человека. Эта патология проявляется не только в расцветке органов зрения, но и в окрасе радужки',
