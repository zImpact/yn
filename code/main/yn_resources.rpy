...
init:
    ...
    Андрей Катаев - Да, код писал я, но сколько орфографических и пунктуационных ошибок я нашел!

    Даниил Бухичевский - Да, сценарий мой, но вы бы знали, сколько ошибок было мной найдено!
