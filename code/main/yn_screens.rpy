...
screen yn_notes_places_main_menu():
    ...
    text "{font=[yn_main_menu_font]}{color=#000000}Места{/font}{/color}":
        size 60
        xalign 0.37
        ypos 55
        antialias True
