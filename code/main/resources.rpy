init python:
    ...
    yn_colors["yn_julya"] = {"speaker_color": "#F08080"}
...
init:
    ...
    Благодарим вас за прочтение нашей модификации!


    {b}СОЗДАТЕЛИ{/b}
    Человек, который непонятно зачем всё это придумал\nи написал - Даниил Бухичевский.

    Я это все запрограммировал и срежиссировал - Андрей Катаев.
    ...
    Он сделал с десяток треков, и подошли почти все - Алан Кокоев.

    Жуля - художница спрайтов.

    Мария Ракшинская - художница CG.
    ...
    Фёдор Чернышов - Спасибо, бро, ты очень выручил! Первый, кто протестировал полную версию.

    Исаева Дарья - Вместе искали заковыристые предложения и логические несостыковки.
    ...
    $ yn_titles_text_act_one_bad_end = """
    Благодарим вас за прочтение первого акта нашей модификации. \nК сожалению, вы попали на плохую концовку. Попробуйте совершить другие выборы, дабы узнать больше про историю Лагеря.


    {b}СОЗДАТЕЛИ{/b}
    Даниил Бухичевский - автор идеи, сценарист.
